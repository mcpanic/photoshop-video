  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $("body").on("mouseenter", ".popover", function(){
        ...
        $(this).find(".popover-inner").addClass("popover-highlight");
      });
      ...
      $("body").on("mouseleave", ".popover", function(){
        var index = parseInt($(this).css("z-index"));
        $(this).css("z-index", index-1);
        $(this).find(".popover-inner").removeClass("popover-highlight");
      });
      ...
      $.each(labels, function(index, label){
        ...
        // Adding Marker Sticks that connect markers with popovers
