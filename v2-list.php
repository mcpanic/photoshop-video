...
*/
      ...
      $.each(videos_array, function(index, value){
        ...
        if (interface_id == 1) {
          ...
          var html2 = "";
          if (is_admin)
            html2 = " | <a href='v2-label.php" + params + "'>(Label)</a>";
            //html2 = "<p class='video-info-meta pull-right'><a href='v2-label.php" + params + "'>(Label)</a></p>";

          $title = $("<h3/>").addClass("span12").append("<a href='v2-browse.php" + params + "'>" + this.title + "</a>");
          ...
          */
          ...
          $title = $("<h3/>").append("<a href='v2-browse.php" + params + "'>" + this.title + "</a>");
